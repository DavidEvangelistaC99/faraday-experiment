...
$Id: views.py 7112 2020-04-13 22:22:53Z brideout $
'''
...
def check_registration(view):
    def check_cookies(request, *args, **kwargs):
        ...
        try:
            ...
            return(HttpResponseRedirect(reverse('view_registration')))
    ...
    if request.method == 'GET':
        if len(list(request.GET.keys())) > 0:
            ...
            if form.is_valid():
                ...
                response.set_cookie('user_fullname', form.cleaned_data['user_fullname'], max_age=max_age)
                response.set_cookie('user_email', form.cleaned_data['user_email'], max_age=max_age)
                response.set_cookie('user_affiliation', form.cleaned_data['user_affiliation'], max_age=max_age)
                return(response)
        else:
