...
$Id: cedar.py 7135 2020-07-06 22:24:33Z brideout $
"""
...
class MadrigalCedarFile:
    ...
    def _createArrayLayout(self, f, arraySplittingParms):
        ...
        for tableSubset in tableSubsets:
            ...
            # time index
            time_indices = numpy.zeros((1, len(tableSubset.table)), numpy.int)
            ...
            for indParm in indParmList:
                ...
                indParmIndexDict[indParm] = numpy.zeros((1, len(tableSubset.table)), numpy.int)
    ...
    def _createArrayLayout2(self):
        ...
        total_allowed_records = 0 # make sure all ind parameters declared by checking that the product
                                  # of all the ind parm value lengths time the numner of time is equal
            ...
            for key in list(arrDict.keys()):
                ...
                for indParm in indParmList:
                    if indParm in self._arraySplitParms:
                        ...
                        continue
                    values = tableSubset.table[indParm]
                    indParmIndexDict[indParm] = numpy.zeros((len(tableSubset.table),), numpy.int)
                ...
                timeIndices = numpy.zeros((len(tableSubset.table),), numpy.int)
        ...
        for i in range(len(groups)):
            ...
            for indParm in indParmList:
                ...
                if madParmObj.isInteger(indParmString):
                    thisVar = thisGroup.createVariable(indParmString, 'i8', (indParmString,),
                                                       zlib=True)
