...
*
*     $Id: _Madrec.c 7044 2019-10-07 19:13:16Z brideout $
*/
...
static PyObject * _Madrec_convertGeodeticGeomagnetic(PyObject * self, PyObject * args)
{
    ...
    int direction, year;
    double gclat, rkm;
    double dat[44]; /* GEOCGM01_F77 returns 11 parameters (slar, slor, clar, clor,
    ...
    if (direction == 1)
    {
        ...
        CONVRT_F77(&direction, &orgLat, &alt, &gclat, &rkm);

	/* write gclat and glon into dat */
        dat[0] = gclat;
        dat[1] = orgLon;

        GEOCGM01_F77(&direction, &year, &alt, dat, pla, plo);
	/* CGM_LAT */
        newLat = dat[2];
        /* CGM_LONG */
        newLon = dat[3];
	...
	direction = 2;
        CONVRT_F77(&direction, &newLat, &alt, &gclat, &rkm);
    }
