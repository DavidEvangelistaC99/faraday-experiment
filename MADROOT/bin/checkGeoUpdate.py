#!/home/david/Documents/faraday-experiment/MADROOT/bin/python
...
try:
    ...
    sys.path.append('/home/david/Documents/faraday-experiment/MADROOT/lib/python')
...
try:
    ...
    openMad3Url = 'http://www.haystack.mit.edu/madrigal/distributionFiles/mad3/'
    ...
    f = urllib.request.urlopen('http://www.haystack.mit.edu/madrigal/distributionFiles/mad3/geofil.tar.gz')
