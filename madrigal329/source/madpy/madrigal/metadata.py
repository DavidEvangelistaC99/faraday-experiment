...
class MadrigalDB:
    ...
    __hardCodeMadRoot          = '/opt/madrigal'
    __hardCodeMadServer        = 'http://localhost'
    __hardCodeMadServerRoot    = 'madrigal'
    __hardCodeSiteId           = '999'
    __hardCodeHtmlStyle        = '<BODY BGCOLOR=#FFFFFF LINK=#008000 VLINK=#003366>'
    __hardCodeIndexHead        = 'Welcome to the Madrigal Database at Docker'
    __hardCodeContact          = '<A HREF="MAILTO:david.evangelista.c@gmail.com">Madrigal administator</A><BR>'
    ...
    def getExperimentDirs(self):
        ...
        are those of the form of the regular expression $/opt/madrigal/experiments[0-9]*
    ...
    def getBackgroundColor(self):
        ...
        Returns the color string from the body tag in madrigal.cfg. For example, will return
            '#FFFF88; if <BODY BGCOLOR=#FFFFFF LINK=#008000 VLINK=#003366> is <BODY BGCOLOR=#FFFF88 LINK=#008000 VLINK=#003366>
    ...
    def getKinstKindatConfig(self, kinst, kindat, iniFile=None):
        """getKinstKindatConfig gets information for the /opt/madrigal/cachedFiles.ini needed to create Madrigal3 files if not specified.
        ...
        Inputs:
            ...
            iniFile - the ini file to use.  If None, uses default ini file $/opt/madrigal/cachedFiles.ini
    ...
    def createGroupIdWithList(self, user_fullname, user_email, user_affiliation, fileList):
        """createGroupIdWithList writes to $/opt/madrigal/metadata/cedarGroupId.hdf5, the file that records citations to groups of files
    ...
    def getListFromGroupId(self, group_id):
        """getListFromGroupId returns a list of files associated with group_id in $/opt/madrigal/metadata/cedarGroupId.hdf5, the file that records citations to groups of files
